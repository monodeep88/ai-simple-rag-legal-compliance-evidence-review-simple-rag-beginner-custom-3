# Legal Compliance Evidence Review Simple RAG - Beginner Custom 3 - Beginner Simple RAG

    ## Project Overview

    Legal Compliance Evidence Review Simple RAG - Beginner Custom 3 - Beginner Simple RAG is a complete full-stack AI project for **Simple RAG** at **Beginner** difficulty. It includes a FastAPI backend, a React frontend, sample documents, vector search with ChromaDB support, source citations, timeline logs, structured run storage, Docker files, and tests.

    A practical Legal Compliance Evidence Review Simple RAG - Beginner Custom 3 assistant tailored for Simple RAG workflows.
    ...
    ```text
    ai-simple-rag-legal-compliance-evidence-review-simple-rag-beginner-custom-3/
      backend/
        app/
          main.py
          config.py
